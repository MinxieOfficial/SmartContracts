...
contract Master is Ownable {
    ...
    // Market oracle provides the minx/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _minx) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = minx.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && minx.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(minx.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return minx.totalSupply().toInt256Safe()
